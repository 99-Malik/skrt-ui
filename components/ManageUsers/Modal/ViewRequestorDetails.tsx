...
interface ViewRequestorDetailsProps {
    isOpen: boolean;
    onClose: () => void;
    user: UserData | null;
}

export default function ViewRequestorDetails({ isOpen, onClose, user }: ViewRequestorDetailsProps) {
                    ...
                    <div className="">
                        ...
                        <div className="flex items-center justify-between mb-6 p-6 border-b border-gray-200">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="flex items-center gap-2 px-3 py-1 rounded-full bg-[#25C889] text-white text-xs font-normal">
